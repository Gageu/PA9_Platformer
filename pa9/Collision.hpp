 ...
 **********************************************************
 * ATTENTION!!!!!!!!!!!!!!!                               *
 * SEE COLLISION.CPP for credit and explanation           *
 **********************************************************
 *
 *
 *
 *
 * Also, obviously, this is not our code, again look at Collision.cpp
 *
 *
 *
 *
...
namespace Collision {
	...
	//////
	bool PixelPerfectTest(const Entity& Object1, const Entity& Object2, sf::Uint8 AlphaLimit = 0);
